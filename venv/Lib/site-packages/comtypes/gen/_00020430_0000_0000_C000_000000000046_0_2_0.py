...
__all__ = [ 'OLE_XPOS_HIMETRIC', 'OLE_YSIZE_HIMETRIC', 'FONTNAME',
           'LoadPictureConstants', 'OLE_YSIZE_PIXELS',
           'OLE_YSIZE_CONTAINER', 'Gray', 'OLE_CANCELBOOL',
           'OLE_TRISTATE', 'OLE_XSIZE_PIXELS', 'OLE_HANDLE',
           'FONTITALIC', 'Monochrome', 'Checked', 'IFontEventsDisp',
           'IFont', 'StdPicture', 'Picture', 'Unchecked', 'StdFont',
           'Font', 'Color', 'IPicture', 'OLE_XPOS_CONTAINER',
           'OLE_YPOS_CONTAINER', 'OLE_YPOS_PIXELS', 'FONTSIZE',
           'Default', 'OLE_COLOR', 'OLE_ENABLEDEFAULTBOOL',
           'OLE_XPOS_PIXELS', 'OLE_XSIZE_HIMETRIC', 'FONTUNDERSCORE',
           'OLE_XSIZE_CONTAINER', 'FONTBOLD', 'OLE_YPOS_HIMETRIC',
           'VgaColor', 'IPictureDisp', 'FontEvents', 'IFontDisp',
